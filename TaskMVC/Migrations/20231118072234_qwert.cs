        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotolPrice = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Price", "Quantiy", "Title", "TotolPrice" },
                values: new object[,]
                {
                    { 1, 74.090000000000003, 55.0, "HDD 1TB", 0.0 },
                    { 2, 190.99000000000001, 102.0, "HDD 1TB", 0.0 },
                    { 3, 8.3200000000000003, 47.0, "HDD 1TB", 0.0 }
                });
