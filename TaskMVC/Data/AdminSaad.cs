...
public class Saad
{
    ...
    {
        await CreateUserAsync(userManager, "Abdumutal.com", "Abdumutal", "A0601221a_", ERole.ADMIN);
        await CreateUserAsync(userManager, "Nuriddin.com", "Nuriddin", "B0601221b_", ERole.USER);
    }
